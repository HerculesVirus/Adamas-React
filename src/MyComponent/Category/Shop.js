...
const Shop = ()=> {
    ...
    useEffect(()=>{
        ...
        if(goal === false){
            axios.get(`http://localhost:8000/api/admin/publicsite/category/product?page=${currentPage}`)
            .then( res =>{
            ...
            axios.get(`http://localhost:8000/api/admin/publicsite/category/product?page=${currentPage}&id=${id}`)
            .then(res => {
