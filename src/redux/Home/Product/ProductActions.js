...
export const fetchProduct = ()=> {
    return(dispatch) => {
        ...
        axios.get(`${process.env.REACT_APP_URL}/v1/site-product/product`)
        .then(res =>{
...
export const featuredProduct = ()=> {
    return(dispatch) => {
        ...
        axios.get(`${process.env.REACT_APP_URL}/v1/site-product/product/featured`)
        .then(res =>{
...
export const latestProduct = ()=> {
    return(dispatch) => {
        ...
        axios.get(`${process.env.REACT_APP_URL}/v1/site-product/product/latest`)
        .then(res =>{
            const product = res.data
            // console.log(`Product Actions`)
            // console.log(product)
